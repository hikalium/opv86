...
function appendOpListElement(oplist, op, index) {
    ...
    oplistRow.click(() => {
        ...
        if (op.page !== undefined && op.document !== undefined) {
            ...
            opDescription.append($('<p>').append($(`<a target="_blank" href='./sdmparser/pdf/${op.document}.pdf#page=${op.page}'>Source: p.${op.page} of Intel SDM${volume} (click to open PDF)</a>`)));
        }
